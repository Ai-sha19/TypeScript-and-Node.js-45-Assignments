...
// Defining an array containing the names of islamic month
let islamicMonth = ["Rajab", "Shaaban", "Ramadan", "Shawwal"];
// Produce an index error
console.log(islamicMonth[4]);
//Correction of error
console.log(islamicMonth[2]);
export {};
